                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead>
                            <tr>
                                ...
                                <th class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Order Status
                                </th>
                                <th class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Payment
                                    Status</th>
                                <th class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Order
                                    Amount</th>
                            ...
                            @foreach ($orders as $order)
                                @php
                                    ...
                                    if ($order->payment_status == 'pending') {
                                        $payment_status =
                                            '<span class="bg-blue-600 py-1 px-3 rounded text-white shadow">Pending</span>';
                                    }
