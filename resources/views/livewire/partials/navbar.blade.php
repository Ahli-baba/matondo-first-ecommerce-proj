                ...
                <div
                    ...
                    <div
                        ...
                        <a wire:navigate href="/"
                            class="font-medium py-3 md:py-6 {{ $current === '/' ? 'text-blue-600' : 'text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300' }}">Home</a>

                        <a wire:navigate href="/categories"
                            class="font-medium py-3 md:py-6 {{ $current === 'categories' ? 'text-blue-600' : 'text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300' }}">Categories</a>

                        <a wire:navigate href="/products"
                            class="font-medium py-3 md:py-6 {{ str_starts_with($current, 'products') ? 'text-blue-600' : 'text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300' }}">Products</a>

                        <a wire:navigate href="/cart"
                            class="font-medium flex items-center py-3 md:py-6 {{ $current === 'cart' ? 'text-blue-600' : 'text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300' }}">
                        ...
                        @guest
                            <div class="pt-3 md:pt-0">
                                <a wire:navigate href="/login"
                                    class="py-2.5 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent {{ $current === 'login' ? 'bg-blue-700' : 'bg-blue-600' }} text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                        ...
                        @auth
                            <div
                                ...
                                <!-- Dropdown Menu -->
                                <div
                                    class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 md:w-48 hidden z-10 bg-white md:shadow-md rounded-lg p-2 dark:bg-gray-800 md:border dark:border-gray-700 dark:divide-gray-700 before:absolute top-full md:border before:-top-5 before:start-0 before:w-full before:h-5">

                                    <!-- My Orders -->
                                    <a class="block py-2 px-3 text-sm hover:bg-gray-100 dark:hover:bg-gray-700"
                                    ...
                                    <!-- My Account -->
                                    <a href="#"
                                        class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-gray-600">
                                        My Account
                                    </a>
