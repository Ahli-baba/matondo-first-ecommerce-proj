            ...
            <div class="md:w-1/4">
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="flex justify-between mb-2">
                        <span>Subtotal</span>
                        <span>{{ \Illuminate\Support\Number::currency($order->grand_total, 'INR') }}</span>
                    </div>
                    <div class="flex justify-between mb-2">
                        <span>Taxes</span>
                        <span>₹0.00</span>
                    ...
                    <div class="flex justify-between mb-2">
                        ...
                        <span class="font-semibold"><span
                                class="font-semibold">{{ \Illuminate\Support\Number::currency($order->grand_total, 'INR') }}</span></span>
                    </div>
